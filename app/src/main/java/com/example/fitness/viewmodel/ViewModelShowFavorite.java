...
public class ViewModelShowFavorite extends ViewModel {
    ...
    public void ShowFavorite(String token) {
        Repository.INSTACNCE.CustomResponse(Api.Compation.invoke().ShowFavorite(token), object -> mutableLiveDataPost.setValue((List) object));
    }
